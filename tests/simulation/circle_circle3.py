...
circle2 = Circle(20, position=Point(850, 350), 
                        moment_inertia=1, mas=0.05, veloсity=Vector(0, -0))
circle3 = Circle(20, position=Point(800, 350), 
                        moment_inertia=1, mas=0.05, veloсity=Vector(0, -0))
circle4 = Circle(20, position=Point(750, 350), 
                        moment_inertia=1, mas=0.05, veloсity=Vector(0, -0))
circle5 = Circle(20, position=Point(700, 350), 
                        moment_inertia=1, mas=0.05, veloсity=Vector(0, 0))
circle6 = Circle(20, position=Point(650, 350), 
                        moment_inertia=1, mas=0.05, veloсity=Vector(0, -0))
circle7 = Circle(20, position=Point(600, 350), 
                        moment_inertia=1, mas=0.05, veloсity=Vector(0, -0))
circle8 = Circle(20, position=Point(200, 350), 
                        moment_inertia=1, mas=0.05, veloсity=Vector(4, -0))
...
pygameRender = PygameRender(simManager, time=9, collectInfo=True, drawinteraction=True)
pygameRender.run()
